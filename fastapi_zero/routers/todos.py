...
async def create_todo(
    todo: TodoSchema, session: SessionDep, user: CurrentUserDep
):
    db_todo = Todo(
        title=todo.title,
...
async def delete_todo(todo_id: int, session: SessionDep, user: CurrentUserDep):
...
async def patch_todo(
    todo_id: int, todo: TodoUpdate, session: SessionDep, user: CurrentUserDep
):
